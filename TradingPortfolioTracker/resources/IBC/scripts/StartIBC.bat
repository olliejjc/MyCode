...
if not defined IBC_PATH set IBC_PATH=C:\laragon\www\tradingportfoliotracker\resources\IBC
if not defined CONFIG set CONFIG=C:\laragon\www\tradingportfoliotracker\resources\IBC\config.ini
