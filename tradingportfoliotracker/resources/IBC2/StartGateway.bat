...
set TWS_MAJOR_VRSN=980
set CONFIG=C:\laragon\www\tradingportfoliotracker\resources\IBC2\config.ini
set TRADING_MODE=
set TWOFA_TIMEOUT_ACTION=exit
set IBC_PATH=C:\laragon\www\tradingportfoliotracker\resources\IBC2
set TWS_PATH=%SYSTEMDRIVE%\Jts
set TWS_SETTINGS_PATH=
set LOG_PATH=%IBC_PATH%\Logs
set TWSUSERID=crows241
set TWSPASSWORD=Timesplitters234
set FIXUSERID=
set FIXPASSWORD=
set JAVA_PATH=
set HIDE=
